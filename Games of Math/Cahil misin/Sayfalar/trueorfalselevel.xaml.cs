...
{
    public partial class trueorfalselevel : PhoneApplicationPage
    {
        IsolatedStorageSettings stroge;
        
        public trueorfalselevel()
        {
            InitializeComponent();
        ...
        private void play1_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/Sayfalar/TrueorFalse.xaml", UriKind.Relative));
        ...
        {
            int a = Convert.ToInt32(IsolatedStorageSettings.ApplicationSettings["level"]);
            if (a >= 1)
            {
        ...
        {
            txtmessega.Text = "1.3 seconds for each question";
            grid1.Visibility = Visibility.Visible;
            grid2.Visibility = Visibility.Visible;
        }
