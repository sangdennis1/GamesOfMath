...
{
    public partial class classicgamelevel : PhoneApplicationPage
    {
        ...
        {
            int c = Convert.ToInt32(IsolatedStorageSettings.ApplicationSettings["levelclassic"]);
            if (c > 1)
            {
        ...
        {
            int a = Convert.ToInt32(IsolatedStorageSettings.ApplicationSettings["levelclassic"]);
            if (a >= 1)
            {
